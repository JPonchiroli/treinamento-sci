...
begin
    ...
    dmProjeto.qConsultaPessoa.ParamByName('bdcodsala').AsInteger := enCodigoSala.Codigo;
    dmProjeto.qConsultaPessoa.Open;

    if not dmProjeto.qConsultaPessoa.IsEmpty then
    begin
      eNomeSala.Text := dmProjeto.qConsultaPessoa.FieldByName('bdnomesala').AsString;
      wLotacaoAtualSala := dmProjeto.qConsultaPessoa.FieldByName('bdlotacaoatualsala').AsString;
      wLotacaoMaximaSala := dmProjeto.qConsultaPessoa.FieldByName('bdlotacaomaximasala').AsString;
...
begin
    ...
    begin
      ...
      wLotacaoAtualEspacoCafe := dmProjeto.qConsultaEspacoCafe.FieldByName('bdlotacaoatualespacocafe').AsString;
      wLotacaoMaximaEspacoCafe := dmProjeto.qConsultaEspacoCafe.FieldByName('bdlotacaomaximaespacocafe').AsString;
...
begin
  ...
  begin
    ...
    {ShowMessage('wJaEtapa1: ' + wJaEtapa1 + 'wJaEtapa2: ' + wJaEtapa2);
    ShowMessage('cmNumeroEtapa.Text: ' + cmNumeroEtapa.Text);}
